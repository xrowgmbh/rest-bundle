...
define('jso',['require','exports','module','./store','./utils','./Config'],function(require, exports, module) {
	...
	JSO.prototype._authorize = function(callback, opts) {
		...
		var authorization = this.config.get('authorization', null, true);
		var client_id = this.config.get('client_id', null, true);
		var client_secret = this.config.get('client_secret', null, true);
		...
		if(typeof opts.grant_type != undefined) {
			delete request.response_type;
			reques.grant_type = opts.grant_type;
		}
		if(typeof opts.scope != undefined)
			reques.scope = opts.scope;
		if(typeof opts.username != undefined)
			reques.username = opts.username;
		if(typeof opts.password != undefined)
			reques.password = opts.password;

		utils.log("reques", reques);
