    ...
    IOAuth2GrantClient, IOAuth2GrantExtension, GrantExtensionDispatcherInterface
{
    ...
    public function checkUserCredentials(IOAuth2Client $client, $username, $password)
    {
        ...
        if (null !== $user) {
            ...
            if ($user == 'LOCKOUT')
                throw new \OAuth2\OAuth2ServerException(\OAuth2\OAuth2::HTTP_BAD_REQUEST, \OAuth2\OAuth2::ERROR_INVALID_GRANT, $this->container->get('translator')->trans("Your account has been locked because you tried to login too many times"));
            return array(
                'data' => $user,
            );
        }
