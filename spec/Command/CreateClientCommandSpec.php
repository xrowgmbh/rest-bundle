...
namespace spec\xrow\restBundle\Command;

use FOS\OAuthServerBundle\Model\ClientManager;
use PhpSpec\ObjectBehavior;
use Prophecy\Argument;
use xrow\restBundle\Model\Client;
...
class CreateClientCommandSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('xrow\restBundle\Command\CreateClientCommand');
    }
    ...
    {
        $this->getName()->shouldReturn('xrow:oauth-server:create-client');
    }
