...
class ResponseListener
{
    public function onKernelResponse(FilterResponseEvent $event)
    {
        ...
        if (strpos($request->getRequestUri(), '/xrowapi/v1/') !== false || strpos($request->getRequestUri(), '/oauth/v2/') !== false || strpos($request->getRequestUri(), '/sso/') !== false || $request->getRequestUri() == '/sso') {
            ...
            if (strpos($request->getRequestUri(), '/xrowapi/v1/') !== false || strpos($request->getRequestUri(), '/sso/') !== false || $request->getRequestUri() == '/sso') {
